...
if awesome.startup_errors then
    naughty.notify({ preset = naughty.config.presets.critical,
                     title = "You fucked up your config, good luck fixing it, LMAO!!",
...
beautiful.menu_width=125
beautiful.menu_bg_normal="#2e3440"
beautiful.menu_bg_focus="#3b4252"
beautiful.menu_fg_focus="#eceff4"
beautiful.menu_submenu_icon=""beautiful.menu_height=20
beautiful.menu_width=125
beautiful.menu_bg_normal="#2e3440"
beautiful.menu_bg_focus="#3b4252"
beautiful.menu_fg_focus="#eceff4"
beautiful.menu_submenu_icon=""
beautiful.menu_font="Liberation Mono 10"beautiful.menu_height=20
beautiful.menu_width=125
beautiful.menu_bg_normal="#2e3440"
beautiful.menu_bg_focus="#3b4252"
beautiful.menu_fg_focus="#eceff4"
beautiful.menu_submenu_icon=""
beautiful.menu_font="Liberation Mono 10"
beautiful.menu_font="Liberation Mono 10"
	    ...
	    awful.key({ modkey }, "x", function () awful.spawn("betterlockscreen -l") end,
		 ...
		 awful.key({ modkey }, "a", function () awful.spawn("rofi -modi windowcd -show windowcd") end,
				{description = "show windows (current desktop)", group = "launcher"}),   
				 ...
				 awful.key({ modkey }, "e", function () awful.spawn("rofi -show power-menu -modi power-menu:rofi-power-menu --no-symbols") end,
					{description = "power menu zzz", group = "launcher"}),          
...
beautiful.border_normal = "#5e81ac"
beautiful.border_focus = "#81a1c1"
beautiful.border_marked = "#ebcb8b"
...
awful.spawn.with_shell("feh --bg-fill ~/wall.jpeg")
